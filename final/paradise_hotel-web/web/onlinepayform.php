...
<html>
<head>
<title>Hotel Checkout Form Responsive Widget Template | Home :: w3layouts</title>
<!-- for-mobile-apps -->
...
<body>
<div class="main">
	<h1>HOTEL Secure Online Payment</h1>
	...
	<div class="hotel-right  vlcone">
		...
		<div class="hotel-form">
			...
			<ul class="list_ins1">
						...
						<li>Room Type</li>
						<li>Amount per day</li>	
						<li>Total days</li>
						<li>Total Amount</li>
			</ul>
			<ul class="list_ins2">
						
						<?php   echo "<li>: ".$_SESSION['drpRoom']."</li>" ?>
						<?php 	echo "<li>: $".$_SESSION[$_SESSION['drpRoom']]."</li>" ?>
						<?php if(empty($_SESSION['dff'])){$_SESSION['dff']=1;}	echo "<li>: ".$_SESSION['dff'] ." days</li>" ?>
						<?php 	echo "<li>: $".$_SESSION[$_SESSION['drpRoom']]*$_SESSION['dff'] ."</li>" ?>
			</ul>
			<div class="clear"></div>
		</div>
		<div class="pay-form">
	...
	<div class="hotel-left">
		<div class="hotel-text">
			<h2><a href="index.php" style="color:white;">The Paradise</a></h2>
			<?php echo '<h3> $'.$_SESSION['Double Room'].'/ <span>day</span></h3>'; ?>	
			<p>Entire Room with AC and free wifi</p>

		</div>
	</div>
	<div class="clear"></div>
	<p class="footer">&copy; 2018 Hotel Checkout Form. All Rights Reserved </p>
</div>
</body>
</html>