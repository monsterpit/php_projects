	...
	<div class="header">
		...
		<div class="h_right">
			...
			<ul class="menu">
				...
				<li class="active"><a href="Admincontact.php">contact</a></li> | 
				<?php
				//error_reporting(0);
...
<div class="wrap">
	<div class="main">
		<div class="res_online">
			...
			<p class="para">“We all need people who will give us feedback. That’s how we improve.”</br>
</p>
...
<div id="content" style="overflow: auto;">
	<form id="login" method="post" action="UpdateRecord.php" >
		<table   >
				<tr>
					<td>
						<div id="info" style="color:#000000;font-size:40px;font-weight:bolder;font-family:Arial Black" >Customer Queries & Feedbacks</div>
					</td>
				</tr>
				<tr>
					<td>
						<div id="info"  >
							<table style="width:900px;">
								<tr style="color:#000000;font-weight:bold;text-align:center;"><td>id</td><td>username</td><td>email</td><td>contact</td><td>message</td></tr> 
								<?php
									...
									if (mysqli_num_rows($result) > 0) {
										...
										while($row = mysqli_fetch_assoc($result)) {
											echo "<tr><td>{$row["id"]}</td><td>{$row["username"]}</td><td>{$row["email"]}</td><td>{$row["contact"]}</td><td>{$row["message"]}</td></tr>";
										}
									}
									else {
