...
<div id="content" style="overflow: auto;">
	<form id="login" method="post" action="UpdateRecord.php" >
		<table   >
				<tr>
					<td>
						<div id="info" style="color:#000000;font-size:40px;font-weight:bolder;font-family:Arial Black" >Rooms Details</div>
					</td>
				</tr>
				<tr>
					<td>
						<div id="info"  >
							<table style="width:900px;">
								<tr style="color:#000000;font-weight:bold;text-align:center;"><td>id</td><td>room</td><td>rate</td><td>action</td></tr> 
								<?php
									...
									if (mysqli_num_rows($result) > 0) {
										...
										while($row = mysqli_fetch_assoc($result)) {
											echo "<tr><td width='25%'>{$row["id"]}</td><td width='25%'>{$row["room"]}</td><td width='25%'><input type='text' name='rate{$row["id"]}' value='{$row["rate"]}'   /></td><td width='25%'><input type='submit' value='update'    formaction='UpdateRecord.php?id={$row["id"]}'></td></tr>";
										}
									}
									else {
