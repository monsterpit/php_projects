					...
					<div id="info" >
						...
						<table>
							<tr><td>Prescription Range Left eye:</td><td><input type="text" name="txtPrL"  class="txtbx"   /></td></tr>
								...
								if(!empty($_GET['id']))
								{
									echo "<tr><td>Eye-Wear Model Name :</td><td><select name='drpGlass'  class='txtRoom' style='width:300px '>";
									if ($_GET['id']==1){
										echo "<option value='MLG MICRON Onyx' selected='selected'>MLG MICRON Onyx</option>";
									}
									else{
										echo "<option value='MLG MICRON Onyx'>MLG MICRON Onyx</option>";
									}
									if ($_GET['id']==2){
										echo "<option value='VINYL Onyx z' selected='selected'>VINYL Onyx z</option>";
										}
									else{
										echo "<option value='VINYL Onyx z'>VINYL Onyx z</option>";
										}
									if ($_GET['id']==3){
										echo "<option value='Desmo - Onyx' selected='selected'>Desmo - Onyx</option>";
										}
									else{
										echo "<option value='Desmo - Onyx'>Desmo - Onyx</option>";
										}
									if ($_GET['id']==4){
										echo "<option value='Penta - Mercury' selected='selected'>Penta - Mercury</option>";
										}
									else{
										echo "<option value='Penta - Mercury'>Penta - Mercury</option>";
										}
									if ($_GET['id']==5){
										echo " <option value='INTERCEPT Raven Grey' selected='selected'>INTERCEPT Raven Grey</option>";
										}
									else{
										echo "<option value='INTERCEPT Raven Grey'>INTERCEPT Raven Grey</option>";
										}
									if ($_GET['id']==6){
										echo "<option value='Sparrow - Onyx / Red' selected='selected'>Sparrow - Onyx / Red</option>";
										}
									else{
										echo "<option value='Sparrow - Onyx / Red' >Sparrow - Onyx / Red</option>";
										}
									if ($_GET['id']==7){
										echo "<option value='RAZER CERBERUS Onyx Grey' selected='selected'>RAZER CERBERUS Onyx Grey</option>";
										}
									else{
										echo "<option value='RAZER CERBERUS Onyx Grey'>RAZER CERBERUS Onyx Grey</option>";
										}
									if ($_GET['id']==8){
										echo "<option value='DEmissary - Onyx' selected='selected'>Emissary - Onyx</option>";
										}
									else{
										echo " <option value='DEmissary - Onyx' >Emissary - Onyx</option> ";
										}
								}
								else{
									echo "<tr><td>Eye-Wear Model Name :</td><td><select name='drpGlass'  class='txtRoom' style='width:300px '>";
